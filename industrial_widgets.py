...
class RingProgressWidget(QWidget):
    ...
    def paintEvent(self, e):
        ...
        p.setPen(QPen(QColor(self._color), pen_w, cap=Qt.RoundCap))
...
class RotaryEncoderWidget(QWidget):
    ...
    def paintEvent(self, e):
        ...
        p.setPen(QPen(QColor("#4A90D9"), 3, cap=Qt.RoundCap))
...
class MotorStatusWidget(QWidget):
    ...
    def paintEvent(self, e):
        ...
        pen_w = max(4, r / 8)
        p.setPen(QPen(arc_color, pen_w, cap=Qt.RoundCap)); p.setBrush(Qt.NoBrush)
        ...
        # 方向箭头
        p.setPen(QPen(QColor("#ddd"), max(2, r / 15), cap=Qt.RoundCap))
        arrow_r = r * 0.45
...
class ValvePositionWidget(QWidget):
    ...
    def paintEvent(self, e):
        ...
        p.setPen(QPen(color, max(3, valve_r // 6), cap=Qt.RoundCap))
        p.drawLine(QPointF(x1, y1), QPointF(x2, y2))
...
class PowerFactorWidget(QWidget):
    ...
    def paintEvent(self, e):
        ...
        for z_min, z_max, color, label in self.ZONES:
            ...
            p.setPen(QPen(QColor(color), pen_w, cap=Qt.ButtCap)); p.setBrush(Qt.NoBrush)
        ...
        p.setPen(QPen(QColor("#fff"), max(2, r / 20), cap=Qt.RoundCap))
